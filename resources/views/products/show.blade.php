        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <nav class="px-6 pt-6 flex items-center text-sm text-gray-600">
                    ...
                    <a href="{{ route('products.index') }}" class="hover:text-gray-900 transition-colors">All Products</a>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mx-2" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                    ...
                    <div class="flex flex-col lg:flex-row gap-8">
                        ...
                        <div class="lg:w-1/2">
                            <div class="sticky top-6">
                                <!-- Main Image -->
                                <div
                                    class="bg-gray-100 rounded-xl overflow-hidden mb-4 flex items-center justify-center p-8">
                        ...
                        <div class="lg:w-1/2">
                            ...
                            <div class="mt-6">
                                ...
                                <span class="ml-2 bg-red-100 text-red-800 text-xs font-medium px-2 py-0.5 rounded">20%
                                    OFF</span>
                            </div>
                            ...
                            <div class="mt-8">
                                ...
                                <div class="mt-2 flex space-x-2">
                                    <button
                                        class="w-10 h-10 rounded-full bg-gray-900 border-2 border-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"></button>
                                    <button
                                        class="w-10 h-10 rounded-full bg-blue-500 border-2 border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"></button>
                                    <button
                                        class="w-10 h-10 rounded-full bg-red-500 border-2 border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"></button>
                                    <button
                                        class="w-10 h-10 rounded-full bg-green-500 border-2 border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"></button>
                                </div>
                            </div>
                            ...
                            <div class="mt-8">
                                ...
                                <div class="mt-2 flex flex-wrap gap-2">
                                    <button
                                        class="px-4 py-2 border rounded-lg text-gray-700 hover:bg-gray-50 transition">128GB</button>
                                    <button
                                        class="px-4 py-2 border rounded-lg text-gray-700 hover:bg-gray-50 transition">256GB</button>
                                    <button
                                        class="px-4 py-2 border rounded-lg text-gray-700 hover:bg-gray-50 transition">512GB</button>
                                    <button
                                        class="px-4 py-2 border rounded-lg bg-black text-white hover:bg-gray-800 transition">1TB</button>
                                </div>
                            </div>
                                ...
                                <form action="{{ route('cart.add', $product->id) }}" method="POST" class="flex-1">
                                    ...
                                    @auth
                                        @if (Auth::user()->userType !== 'admin')
                                            <button type="submit"
                                                class="w-full px-6 py-3 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors duration-300 flex items-center justify-center">
